...
function (_Component) {
  ...
  function Addquestion() {
    ...
    _this.handleSubmit = function (e) {
      ...
      if (_this.props.addExamCode === 1) {
        _message2.default.success('试题添加成功');
      } else if (_this.props.addExamCode === -1) {
        _message2.default.error('试题添加失败');
      }
    };
  ...
  (0, _createClass2.default)(Addquestion, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_breadcrumb.default.Item, null, "\u6DFB\u52A0\u8BD5\u9898")), _react.default.createElement("div", {
        style: {
          background: '#fff',
          padding: 25,
          minHeight: 225,
